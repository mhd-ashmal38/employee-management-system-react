...
//         <div className="mt-3 shadow border rounded p-2">
//           <div className='text-center'>
//             <img style={{ width: '70px', height: '70px', borderRadius: '50%' }} src="https://imgs.search.brave.com/HTUyKk8Vb_9hSWmylY1BXPS4eO5MdJpnjz-4Mx69OFY/rs:fit:860:0:0/g:ce/aHR0cHM6Ly9jZG4t/aWNvbnMtcG5nLmZs/YXRpY29uLmNvbS8x/MjgvMzEzNS8zMTM1/NzE1LnBuZw" alt="no image" />
//           </div>
//           <Form className='mt-3'>
//             <Row>
//               {/* first name */}
...
//               {/* last name */}
//               <FloatingLabel controlId="floatingInputlname" label="lname" className='mb-3 col-lg-6'>
//                 <Form.Control type="text" placeholder="lname" />
//               </FloatingLabel>
//               {/* email */}
//               <FloatingLabel controlId="floatingInputemail" label="email" className='mb-3 col-lg-6'>
...
//                 {/* female */}
//                 <Form.Check type={"radio"} value={"Female"} label={"Female"} name={'gender'} />
//               </Form.Group>
...
//               {/* location */}
//               <FloatingLabel controlId="floatingInputlocation" label="location" className='mt-3 mb-3 col-lg-6'>
